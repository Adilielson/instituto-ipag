...
export {
  supportsScrollTimeline as $,
  isForcedMotionValue as A,
  isHTMLElement as B,
  isMotionValue as C,
  isPrimaryPointer as D,
  isSVGTag as E,
  Feature as F,
  isVariantLabel as G,
  ...
  resolveMotionValue as U,
  resolveVariant as V,
  resolveVariantFromProps as W,
  scrapeMotionValuesFromProps$1 as X,
  scrapeMotionValuesFromProps as Y,
  setDragLock as Z,
  setFeatureDefinitions as _,
  HTMLVisualElement as a,
  supportsViewTimeline as a0,
  transform as a1,
  addDomEvent as b,
  ...
  calcLength as h,
  cancelFrame as i,
  cancelMicrotask as j,
  collectMotionValues as k,
  convertBoundingBoxToBox as l,
  convertBoxToBoundingBox as m,
  ...
  frame as r,
  frameData as s,
  getFeatureDefinitions as t,
  globalProjectionState as u,
  hover as v,
  interpolate as w,
  isAnimationControls as x,
  isControllingVariants as y,
  isElementTextInput as z
};
