...
const HandHeart = createLucideIcon("hand-heart", __iconNode$x);
const __iconNode$w = [
  [
    "path",
    {
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$w);
const __iconNode$v = [
  [
    "path",
    {
...
const LifeBuoy = createLucideIcon("life-buoy", __iconNode$s);
