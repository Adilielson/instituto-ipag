...
const appCss = "/assets/styles-DUDZUB9S.css";
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-[1600px] items-center justify-between px-6 md:px-12 lg:px-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-2 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "IPAG", className: "h-[68px] md:h-[80px] w-auto transition-transform duration-500 group-hover:scale-105" }) }),
...
const $$splitComponentImporter$m = () => import("./transparencia-BPCG2XbK.mjs");
const Route$m = createFileRoute("/transparencia")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$l = () => import("./quem-somos-5YZIhnTK.mjs");
const Route$l = createFileRoute("/quem-somos")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$k = () => import("./projetos-BFsOu0JM.mjs");
const Route$k = createFileRoute("/projetos")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./parceiros-C7-ejILi.mjs");
const Route$j = createFileRoute("/parceiros")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$i = () => import("./eventos-BFsOu0JM.mjs");
const Route$i = createFileRoute("/eventos")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./contato-DJM8jATO.mjs");
const Route$h = createFileRoute("/contato")({
  head: () => ({
    meta: [{
      title: "Contato — IPAG"
    }, {
...
const $$splitComponentImporter$g = () => import("./blog-BFsOu0JM.mjs");
const Route$g = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./bazar-Cd1mhC9g.mjs");
const Route$f = createFileRoute("/bazar")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$e = () => import("./admin-DRO8bwMm.mjs");
...
const $$splitComponentImporter$d = () => import("./index-DxGWb5Df.mjs");
const Route$d = createFileRoute("/")({
  loader: async () => {
    try {
      const [projetosRes, postsRes, eventosRes] = await Promise.all([supabase.from("projetos").select("*").eq("status", "publicado").order("ordem", {
        ascending: true
      }).order("created_at", {
        ascending: false
      }), supabase.from("posts").select("*").eq("status", "publicado").order("data_publicacao", {
        ascending: false
...
const $$splitComponentImporter$c = () => import("./projetos.index-DvHcTdqA.mjs");
const Route$c = createFileRoute("/projetos/")({
  loader: async () => {
    try {
      const {
        data: projetos,
...
const $$splitComponentImporter$b = () => import("./eventos.index-BUVXdruX.mjs");
const Route$b = createFileRoute("/eventos/")({
  loader: async () => {
    try {
      const {
        data: eventos,
...
const $$splitComponentImporter$a = () => import("./blog.index-4Ixsvtt1.mjs");
...
const $$splitComponentImporter$8 = () => import("./projetos._slug-DBmflJsO.mjs");
const $$splitNotFoundComponentImporter$1 = () => import("./projetos._slug-CWnq1RlE.mjs");
const Route$8 = createFileRoute("/projetos/$slug")({
  loader: async ({
    ...
    const {
      data: project,
      error
    } = await supabase.from("projetos").select("*").eq("slug", params.slug).eq("status", "publicado").maybeSingle();
...
const $$splitComponentImporter$7 = () => import("./eventos._slug-DU9SSc4F.mjs");
const Route$7 = createFileRoute("/eventos/$slug")({
  loader: async ({
    ...
    const {
      data: evento,
      error
    } = await supabase.from("eventos").select("*").eq("slug", params.slug).maybeSingle();
...
const $$splitComponentImporter$6 = () => import("./blog._slug-CNPiSO1H.mjs");
...
const Route$6 = createFileRoute("/blog/$slug")({
  loader: async ({
    ...
    const {
      data: post,
      error: postErr
    } = await supabase.from("posts").select("*").eq("slug", params.slug).eq("status", "publicado").maybeSingle();
...
const $$splitComponentImporter$3 = () => import("./admin.projetos-Cz5sZnCi.mjs");
const Route$3 = createFileRoute("/admin/projetos")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.parceiros-nhYEktOf.mjs");
const Route$2 = createFileRoute("/admin/parceiros")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.eventos-aLgGAkZ7.mjs");
const Route$1 = createFileRoute("/admin/eventos")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.blog-35NWEywL.mjs");
const Route = createFileRoute("/admin/blog")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TransparenciaRoute = Route$m.update({
  id: "/transparencia",
  path: "/transparencia",
  getParentRoute: () => Route$n
});
const QuemSomosRoute = Route$l.update({
  id: "/quem-somos",
  path: "/quem-somos",
  getParentRoute: () => Route$n
});
const ProjetosRoute = Route$k.update({
  id: "/projetos",
  path: "/projetos",
  getParentRoute: () => Route$n
});
const ParceirosRoute = Route$j.update({
  id: "/parceiros",
  path: "/parceiros",
  getParentRoute: () => Route$n
});
const EventosRoute = Route$i.update({
  id: "/eventos",
  path: "/eventos",
  getParentRoute: () => Route$n
});
const ContatoRoute = Route$h.update({
  id: "/contato",
  path: "/contato",
  getParentRoute: () => Route$n
});
...
const BazarRoute = Route$f.update({
  id: "/bazar",
  path: "/bazar",
  getParentRoute: () => Route$n
});
...
const ProjetosIndexRoute = Route$c.update({
  id: "/",
  path: "/",
  getParentRoute: () => ProjetosRoute
});
const EventosIndexRoute = Route$b.update({
  id: "/",
  path: "/",
