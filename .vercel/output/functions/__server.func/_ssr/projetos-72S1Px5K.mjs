...
import { R as Route$h } from "./router-CKAY__H_.mjs";
...
function Projetos() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-container grid gap-12 md:grid-cols-2 lg:grid-cols-3", children: Route$h.useLoaderData().projetos?.map((p, i) => {
