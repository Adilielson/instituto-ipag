...
import { b as Route$b } from "./router-D-TF2mOo.mjs";
...
function Eventos() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-5xl space-y-5 px-4 md:px-8", children: Route$b.useLoaderData().eventos?.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/eventos/$slug", params: {
      slug: e.slug
