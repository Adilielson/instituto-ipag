...
import { R as Route$d, I as IMPACT_STATS, B as Button, P as PARTNERS } from "./router-D-TF2mOo.mjs";
...
function Home() {
  ...
  const loaderData = Route$d.useLoaderData() || {
    projetos: [],
    posts: []
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FrentesAcao, { projetos: loaderData.projetos || [] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-56 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-container", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-20 md:grid-cols-2 lg:grid-cols-3", children: loaderData.posts?.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.15, direction: "up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
        slug: post.slug
    ...
    loaderData.eventos && loaderData.eventos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-56 bg-[#F7F8FA]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-end justify-between gap-16 mb-32 pb-16 border-b border-black/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-8 md:grid-cols-3", children: loaderData.eventos.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.1, direction: "up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-10 rounded-[40px] shadow-card-utility border border-black/5 hover:shadow-premium-utility transition-all duration-500 group h-full flex flex-col", children: [
