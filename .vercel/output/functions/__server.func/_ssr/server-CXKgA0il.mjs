...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BeLl10bH.mjs");
...
const manifest = {
  "02c8e6c07f1e4a843f06b74bbbae1cd39cc72679957fdc14917b7a6e79a8a680": {
    functionName: "getEventos_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "18902821ee7658dc416f6b845a2bbbfcdc69afc5690fe760c9b561a798836b1a": {
    functionName: "updateEvento_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "2762b8da27f2bd41156a91959174a23f06ac02d76e236a8a7ce4183978106d96": {
    functionName: "getProjetos_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "37afd61c13ddc537b9953cec7cf45125716e17e27efbb9d531007363e891809f": {
    functionName: "getProjetoBySlug_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "38b4af48470fcb55cad3f95e631c16d613eddb32eaf8c3142126847e6f92d65d": {
    functionName: "getEventoBySlug_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "52151ebfb2785144c8712316d5feb67e7e40b93d622550b027942d5f4eb136f0": {
    functionName: "getPostBySlug_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "64e617df992cba1401fc93ec369d59df73b546fd35f1d332023cbb5e6bc7a8ee": {
    functionName: "deleteEvento_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "6cf556854356a6e613669a258c856f82f672a7538922a72168c47668d3a6b89f": {
    functionName: "createEvento_createServerFn_handler",
    importer: () => import("./cms-L9jgOCmT.mjs")
  },
  "859a16cba0e4ad6ed215241c768a307f25f794946268666b7f3d1024bbf346d4": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CKAY__H_.mjs").then((n) => n.r),
    import("./start-B8EN1Iss.mjs"),
