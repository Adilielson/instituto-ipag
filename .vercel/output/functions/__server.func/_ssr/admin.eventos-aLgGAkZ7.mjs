...
import { B as Button, s as supabase, g as cn } from "./router-D-TF2mOo.mjs";
import { I as Input, T as Textarea } from "./textarea-FlRFxZ9T.mjs";
...
import { L as Label } from "./label-HcRYBbMk.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6 py-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 sm:grid-cols-4 gap-2", children: [
            ...
            formData.galeria.length < 30 && /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center justify-center aspect-square rounded-lg border-2 border-dashed border-black/5 bg-[#F7F8FA] cursor-pointer hover:bg-black/[0.02] transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-5 w-5 text-[#8E8E8F]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "file", className: "hidden", accept: "image/*", multiple: true, onChange: async (e) => {
