...
function BlogPost() {
  const { post, relatedPosts } = Route.useLoaderData() as { post: any, relatedPosts: any[] };
  if (!post) return null;
      ...
      <section className="py-32">
        <div className="max-container grid lg:grid-cols-3 gap-24 px-4 sm:px-8 lg:px-0 max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
             <div className="sticky top-40 p-10 rounded-[40px] bg-bg border border-black/5">
                <h3 className="text-xl font-black uppercase tracking-tight text-dark mb-6">Compartilhar</h3>
                <div className="flex gap-4">
                    <div className="h-12 w-12 rounded-full bg-white border border-black/5 flex items-center justify-center text-dark hover:bg-primary hover:text-white transition-all cursor-pointer">
