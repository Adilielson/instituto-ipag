...
function Home() {
  ...
  return (
    <div className="bg-white">
      ...
      <section ref={heroRef} className="relative h-[800px] flex items-center bg-dark py-16 sm:py-24 lg:py-32 -mt-[142px] md:-mt-[122px] overflow-visible">
        <HomeHero heroRef={heroRef} />
      </section>

      {/* IMPACTO - Premium Institutional Style with Bazar-like structure */}
      <section id="impacto" className="relative py-24 bg-white overflow-visible">
