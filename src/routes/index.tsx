            ...
            <div className="relative overflow-hidden rounded-[40px] md:rounded-[80px] bg-dark min-h-[500px] md:min-h-[700px] flex items-center p-8 md:p-32 shadow-2xl group">
              <div className="absolute inset-0 z-0">
                ...
                <motion.img 
                  ...
                  alt="Nossa Pegada" 
                  className="w-full h-full object-cover opacity-40 md:opacity-30 relative z-[1]"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-[#0F1115] via-[#0F1115]/90 md:via-[#0F1115]/80 to-transparent z-[2]"></div>
              </div>
